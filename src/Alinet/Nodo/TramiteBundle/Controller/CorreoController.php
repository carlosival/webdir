...
use Alinet\Nodo\TramiteBundle\Entity\Correo;
use Alinet\Nodo\TramiteBundle\Form\CorreoType;
...
class CorreoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TramiteBundle:Correo')->findAll();

        return $this->render('TramiteBundle:Correo:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('TramiteBundle:Correo:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    private function createCreateForm(Correo $entity)
    {
        $form = $this->createForm(new CorreoType(), $entity, array(
            'action' => $this->generateUrl('correo_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TramiteBundle:Correo')->find($id);
        ...
        return $this->render('TramiteBundle:Correo:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('TramiteBundle:Correo:edit.html.twig', array(
            'entity'      => $entity,
