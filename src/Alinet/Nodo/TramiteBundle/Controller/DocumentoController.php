...
use Alinet\Nodo\TramiteBundle\Entity\Documento;
use Alinet\Nodo\TramiteBundle\Form\DocumentoType;
...
class DocumentoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('TramiteBundle:Documento:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    {
       $owner=$this->get('security.context')->getToken()->getUsername();
        ...
        return $this->render('TramiteBundle:Documento:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TramiteBundle:Documento')->find($id);
        ...
        return $this->render('TramiteBundle:Documento:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('TramiteBundle:Documento:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        $entity->setEdiciones($entity->getEdiciones()+1);
        $deleteForm = $this->createDeleteForm($id);
        $editForm = $this->createEditForm($entity);
